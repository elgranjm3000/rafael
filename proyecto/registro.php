        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 ml-auto mr-auto">
            <div class="card card-login">
              <form id="form_registro" class="form" method="post" action="form_verificar.php">
                <div class="card-header card-header-primary text-center">
                  <h4 class="card-title">Validar Correo</h4>
                ...
                <div class="card-body">
                  ...
                  <span class="bmd-form-group"><div class="input-group">
                    ...
                    <input type="email" class="form-control" placeholder="Direccion de correo electronico" name="email">
                  </div></span>
                  <span class="bmd-form-group"><div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text">
                    ...
                    <input  type="password" name="clave" class="form-control" placeholder="Contraseña" pattern="(?=.*\d)(?=.*[a-záéíóúüñ]).*[A-ZÁÉÍÓÚÜÑ].*"
         title="Debe tener al menos una mayúscula, una minúscula y un dígito" minlength="8" maxlength="12">
                  </div></span>
                </div>
                <div class="footer">
                  <div class="text-center">
                      <button type="submit"  class="btn btn-danger btn-lg continuar" >Validar Correo</button>
                  </div>
        ...
        $.ajax({
                ...
                success: function(data) {
                      ...
                      if(data == true){
                        Swal.fire(
                          'Registro',
                          'Registrado con exito. por favor verifique su bandeja de entrada para verificar su cuenta',
                          'success'
                        )
                      }else{
                        Swal.fire({

              ...
              <form class="form" method="" action="">
                ...
                <div class="footer">
                  <div class="text-center">
                      <button  class="btn btn-danger btn-lg">Iniciar sesión</button>
                  </div>
                  <a href="#pablo" class="btn btn-primary btn-link btn-wd btn-lg">¿Olvidó su contraseña?</a>
                  <hr>
                  <a href="#pablo" class="btn btn-primary btn-link btn-wd btn-lg">¿Aún no tienes cuenta gratuita?</a>
                  <div class="text-center">
                   <a href="#pablo" class="btn btn-primary  btn-lg">Cree su cuenta</a>
                 </div>
                </div>
              </form>
            </div>
